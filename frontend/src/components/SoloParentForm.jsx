    ...
    <div
        ...
        >
          <p style={{ marginBottom: "20px" }}>
            <strong>This is to certify that, {display.name || "Name"}, {display.age || "Age"} y/o is a Bonafide 
            resident of {display.address || "Address"} Barangay 145 of this city, since {display.yearOfResidency || "Year"}.</strong>
          </p>
          ...
          <p style={{ marginBottom: "20px" }}>
            <strong>Ms. {display.name || "Name"}, is UNWED, since, {display.unwedYear || "Year"}.</strong>
          </p>

          <p style={{ marginBottom: "20px" }}>
            <strong>Moreover {display.name || "Name"} has two qualified dependent living with 
            her, her daughter {display.daughterName || " Daughter Name"}, {display.daughterAge || "Daughter Age"} y/o, birthday-{display.daughterBirthday || "Daugther Birthday"}; 
            her son {display.sonName || "Son Name"}, {display.sonAge || "Son Age"} y/o, birthday-{display.sonBirthday || "Son Birthday"}, Kinder student.</strong>
          </p>
          ...
          <p style={{ marginBottom: "30px" }}>
            ...
            of Ms. {display.name || "Name"}, qualification to apply for a Solo Parent ID 
            and receive all benefits that go with it.</strong>
          </p>

          <p style={{ marginBottom: "40px" }}>
            <strong>Issued this {display.dateIssued ? formatDate(display.dateIssued) : ""}.</strong>
          </p>
        </div>
                ...
                <Stack spacing={2}>
                  ...
                  />
                   ...
                   <TextField
                    ...
                    onChange={(e) => setFormData({ ...formData, daughterName: e.target.value })}
                    sx={{
                      '& .MuiOutlinedInput-root': {
                        '&:hover fieldset': {
                          borderColor: 'success.main',
