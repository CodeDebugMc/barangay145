          ...
          >
            ...
            <div style={{ position: "absolute", whiteSpace: "pre", top: "450px", left: "80px", width: "640px", lineHeight: "1.6", fontFamily: '"Times New Roman", serif', fontSize: "12pt", fontWeight: "bold" }}>
              <div>
                ...
                <span style={{ color: "black", fontWeight: "bold", fontFamily: '"Times New Roman", serif' }}>Transfer of resident  loading their   personal  things with {display.remarks || ""} </span>{" "}<br />
                <span style={{ color: "red", fontWeight: "bold", fontFamily: '"Times New Roman", serif'  }}>This certification is issued for:</span>{" "}
                <span style={{ color: "black" }}>Transfer of resident from the above stated<br />address to {display.requestReason || ""}</span>
              </div>
            </div>
        ...
        <Card sx={{ borderRadius: 3, boxShadow: 1 }}>
          ...
          <CardContent>
            <Stack spacing={2}>
              ...
              <TextField
                label="Transfer of resident from the above stated address to  *"
                variant="outlined"
                size="small"
                fullWidth
                multiline
