        ...
        >
         ...
         {/* Body */}
            ...
            <p style={{ textIndent: "50px" }}>
                ...
                is a bonafide resident in this Barangay since{" "}
                <span style={{ textDecoration: "underline" }}>
                {formData.sinceYear || "________"}
                </span>
            ...
            <p style={{ textIndent: "50px" }}>
                This certification stating that our Barangay 145 personally known the
                person, that his/her real name is{" "}
                <span style={{ textDecoration: "underline" }}>
                {formData.name || "____________________"}
                </span>
                , and that his/her given address is true.
            </p>
            ...
            <p style={{ textIndent: "50px" }}>
                ...
                , at Barangay 145, Zone 13, Dist. 1, Caloocan City.
            </p>
            </div>
          ...
          <Box sx={{ display: 'flex', gap: 1, pt: 1 }}>
            <Button
              ...
              sx={{
                ...
                '&:hover': { background: 'linear-gradient(45deg, #1b5e20, #2e7d32)' },
                fontWeight: 500,
                py: 1.25,
                textTransform: 'none',
              }}
