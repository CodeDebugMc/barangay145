 ...
 `;
  ...
  async function handleUpdate() {
    try {
      ...
      const updated = { ...formData, certificate_of_residency_id: editingId };
      setRecords(
        records.map((r) => (r.certificate_of_residency_id === editingId ? updated : r))
      );
  ...
  async function generatePDF() {
    ...
    try {
      ...
      const details = [
        ...
        `Certificate ID: ${display.certificate_of_residency_id}`,
        ...
        ``,
        `QR Code URL: ${window.location.origin}/verify-certificate?id=${display.certificate_of_residency_id}`,
      ];
  ...
  const handleTransactionSearch = () => {
    ...
    if (foundRecord) {
      ...
      setEditingId(foundRecord.certificate_of_residency_id); // Indicate viewing/editing
              ...
              <Box sx={{ px: 1, pb: 1 }}>
                ...
                >
                  <Tabs
                    ...
                    aria-label="certificate of residency tabs"
                    variant="fullWidth"
                    sx={{
                ...
                <Card sx={{ borderRadius: 3, boxShadow: 1 }}>
                  <CardHeader
                    title={
                      ...
                      >
                        {editingId ? 'Edit Record' : 'New Certificate of Residency Record'}
                      </Typography>
                    }
                    subheader={
                      selectedRecord &&
                            ...
                            >
                              ...
                              <Box sx={{ display: 'flex', gap: 0.5, ml: 1 }}>
                                ...
                                <IconButton
                                  size="small"
                                  onClick={() =>
                                    handleDelete(record.certificate_of_residency_id)
                                  }
                                  sx={{
                                    color: 'error.main',
                  ...
                  <CardContent>
                    <Box sx={{ display: 'flex', gap: 1, mb: 2 }}>
                      <TextField
                        fullWidth
                        size="small"
                        placeholder="Enter transaction number (e.g., COR-230515-123)"
                    ...
                    <Typography variant="caption" sx={{ color: 'grey.500' }}>
                      ...
                      creating a new certificate. Format: COR-YYMMDD-XXX (e.g.,
                      COR-230515-123)
                    </Typography>
                  </CardContent>
                </Card>
