...
export default function PermitToTravel() {
    ...
    const generateQRCode = async () => {
      if (display.permit_to_travel_id || display.full_name) {
        ...
        const qrContent = `𝗖𝗘𝗥𝗧𝗜𝗙𝗜𝗖𝗔𝗧𝗘 𝗩𝗘𝗥𝗜𝗙𝗜𝗖𝗔𝗧𝗜𝗢𝗡:
          ...
          𝗗𝗼𝗰𝘂𝗺𝗲𝗻𝘁 𝗧𝘆𝗽𝗲: Permit to Travel
          𝗩𝗘𝗥𝗜𝗙𝗜𝗖𝗔𝗧𝗜𝗢𝗡 𝗡𝗢𝗧𝗜𝗖𝗘:
  ...
  async function generatePDF() {
    ...
    try {
      ...
      const details = [
        `Certificate Type: Permit to Travel`,
        `Certificate ID: ${display.permit_to_travel_id}`,
        ...
        ``,
        `QR Code URL: ${window.location.origin}/verify-certificate?id=${display.permit_to_travel_id}`,
      ];
      ...
      // Save the PDF
      const fileName = `Permit_to_Travel_${
  ...
  const handleTransactionSearch = () => {
    ...
    if (foundRecord) {
      ...
      setEditingId(foundRecord.permit_to_travel_id); // Indicate viewing/editing
              ...
              >
                ...
                >
                  ...
                  <p style={{ margin: 0, textIndent: '50px' }}>
                    ...
                    print appear hereon has requested a <i> Permit to Travel</i>{' '}
                    from this office and the result/s is/are listed below and
                    valid for six (6) months only.
                  </p>
                </div>
              ...
              <Box sx={{ px: 1, pb: 1 }}>
                ...
                >
                  <Tabs
                    ...
                    aria-label="permit to travel tabs"
                    variant="fullWidth"
                    sx={{
                  ...
                  {filteredRecords.length === 0 ? (
                    ...
                    <Stack spacing={1}>
                      {filteredRecords.map((record) => (
                        <Card
                          key={record.permit_to_travel_id}
                          sx={{
                            boxShadow: 1,
                            '&:hover': { boxShadow: 2 },
                            ...
                            >
                              ...
                              <Box sx={{ display: 'flex', gap: 0.5, ml: 1 }}>
                                ...
                                <IconButton
                                  size="small"
                                  onClick={() =>
                                    handleDelete(record.permit_to_travel_id)
                                  }
                                  sx={{
                                    color: 'error.main',
                  ...
                  <CardContent>
                    <Box sx={{ display: 'flex', gap: 1, mb: 2 }}>
                      <TextField
                        fullWidth
                        size="small"
                        placeholder="Enter transaction number (e.g., PTT-230515-123)"
                    ...
                    <Typography variant="caption" sx={{ color: 'grey.500' }}>
                      ...
                      creating a new certificate. Format: PTT-YYMMDD-XXX (e.g.,
                      PTT-230515-123)
                    </Typography>
                  </CardContent>
                </Card>
