        ...
        >
          ...
          >
            ...
            >
              Date:{' '}
              {selectedRecord
                ? formatDate(selectedRecord.dateIssued)
                : '_________________'}
            </div>
            ...
            >
              ...
              <br />
              <span style={{ marginLeft: '50px' }}></span>This is to certify
              that the person whose name and thumb print appear
              <br /> here on has requested a Barangay Clearance from this office
              and the result/s
              <br /> is/are listed below and valid for six (6) months only.
            </div>
            ...
            >
              <div>
                ...
                <span style={{ color: 'black', marginLeft: '10px' }}>
                  {selectedRecord
                    ? formatDate(selectedRecord.birthday)
                    : '______________'}
                </span>
                <span
                  style={{
                ...
                <span style={{ color: 'black', marginLeft: '10px' }}>
                  {selectedRecord
                    ? selectedRecord.provincialAddress
                    : '______________'}
                </span>
                <span
                  style={{
            ...
            >
              ...
              <div
                style={{
                  ...
                  fontWeight: 'bold',
                  backgroundImage:
                    'linear-gradient(to bottom, orange 50%, yellow 20%, orange 70%)',
