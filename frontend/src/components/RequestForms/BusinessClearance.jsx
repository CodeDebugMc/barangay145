  ...
  useEffect(() => {
    const generateQRCode = async () => {
      if (display.business_clearance_id || display.full_name) {
        ...
        }/verify/business-clearance/${display.business_clearance_id || 'draft'}`;
        ...
        𝗗𝗼𝗰𝘂𝗺𝗲𝗻𝘁 𝗧𝘆𝗽𝗲: Business Clearance
        𝗩𝗘𝗥𝗜𝗙𝗜𝗖𝗔𝗧𝗜𝗢𝗡 𝗡𝗢𝗧𝗜𝗖𝗘:
 ...
 `;
  ...
  async function generatePDF() {
    ...
    try {
      ...
      const details = [
        `Certificate Type: Business Clearance`,
        `Certificate ID: ${display.business_clearance_id}`,
        ...
        ``,
        `QR Code URL: ${window.location.origin}/verify-certificate?id=${display.business_clearance_id}`,
      ];
              ...
              >
                ...
                >
                  ...
                  <p style={{ margin: 0, textIndent: '50px' }}>
                    ...
                    <i> Business Clearance</i> from this office and the result/s
              ...
              <Box sx={{ px: 1, pb: 1 }}>
                ...
                >
                  <Tabs
                    ...
                    aria-label="business clearance tabs"
                    variant="fullWidth"
                    sx={{
                ...
                <Card sx={{ borderRadius: 3, boxShadow: 1 }}>
                  <CardHeader
                    title={
                      ...
                      >
                        {editingId ? 'Edit Record' : 'New Business Clearance Record'}
                      </Typography>
                    }
                    subheader={
                      selectedRecord &&
                  ...
                  <CardContent>
                    <Box sx={{ display: 'flex', gap: 1, mb: 2 }}>
                      <TextField
                        fullWidth
                        size="small"
                        placeholder="Enter transaction number (e.g., BUS-230515-123)"
                    ...
                    <Typography variant="caption" sx={{ color: 'grey.500' }}>
                      ...
                      creating a new certificate. Format: BUS-YYMMDD-XXX (e.g.,
                      BUS-230515-123)
                    </Typography>
                  </CardContent>
                </Card>
